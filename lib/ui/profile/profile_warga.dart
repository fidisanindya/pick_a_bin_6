...
class ProfileWargaPage extends StatefulWidget {
  const ProfileWargaPage({Key? key}) : super(key: key);

  @override
  State<ProfileWargaPage> createState() => _ProfileWargaPageState();
}

class _ProfileWargaPageState extends State<ProfileWargaPage> {
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Container(
                              padding:
                              const EdgeInsets.only(top: 100.0, left: 30.0),
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Text(
